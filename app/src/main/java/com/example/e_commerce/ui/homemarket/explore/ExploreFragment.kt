...
class ExploreFragment : Fragment() {
    ...
    private val searchRecyclerAdapter : ProductsHomeRecyclerAdapter by lazy { ProductsHomeRecyclerAdapter() }
    override fun onCreateView(
        ...
        val listOfProductSearch = listOf<Product>(
            Product(55,"BeautyCounterBeautyCounter","BeautyCounter","dddd",55.00, listOf("https://images.beautycounter.com/product-images%2F100000182%2Fimgs%2FAT_THE_RED_Y_LIP_DUO_PDP_01.jpg"))
        ...
        searchRecyclerAdapter.setOnItemClickListener(object : ProductsHomeRecyclerAdapter.OnClickOnItem{
