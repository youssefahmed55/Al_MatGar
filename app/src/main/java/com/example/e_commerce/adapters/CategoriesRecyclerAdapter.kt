...
class CategoriesRecyclerAdapter : RecyclerView.Adapter<CategoriesRecyclerAdapter.Holder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): Holder {
        val binding : ItemCatagorieBinding = DataBindingUtil.inflate(LayoutInflater.from(parent.context), R.layout.item_catagorie,parent,false) //Initialize binding
   ...
   inner class Holder(binding: ItemCatagorieBinding) : RecyclerView.ViewHolder(binding.root) {
